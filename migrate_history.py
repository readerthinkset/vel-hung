"""
Migrate phrase history to Hungarian format
Converts legacy keys ('japanese', 'telugu', 'korean') -> 'hungarian'
...
if HISTORY_FILE.exists():
    ...
    print(f"Migrated {updated_count} phrases to Hungarian format")
    if updated_count > 0:
    ...
    print("Ready for new Hungarian content generation")
else:
