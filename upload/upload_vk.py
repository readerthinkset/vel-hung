"""
Upload to VK - VELOCITY HUNGARIAN
"""
import os, vk_api
...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        message = description or "Learn with VELOCITY HUNGARIAN!"
        video = upload.video(video_file=str(video_path), name=title or 'VELOCITY HUNGARIAN', description=description[:220] if description else '', group_id=group_id_int, wallpost=0)
